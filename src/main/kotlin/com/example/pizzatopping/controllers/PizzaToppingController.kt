...
class PizzaToppingController(private val pizzaToppingService: PizzaToppingService) {
    ...
    @Operation(summary = "Get report of pizza topping submission results", description = "Provides total times submitted and favorited per topping. Results will be sorted by total times submitted then total times favorited descending.")
